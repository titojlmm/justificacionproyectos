  ...
  <div>
    ...
    <Dialog v-model:visible="visibleDialog" :style="{width: '450px'}" :modal="true" :maximizable="true">
        ...
        <div>
          ...
          <InputText type="text" v-model="registro.strrefextproyecto" :disabled="disabled" />

          <h5>Código del centro</h5>
          <InputText type="text" v-model="registro.strcodigocentro" :disabled="disabled" />
        </div>
...
<script>
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      const crudservicio = new CentrosService();
